...
public final class FaceTrackerActivity extends AppCompatActivity {
     ...
     */
    private volatile boolean stared = false;
...
//            busy();
    ...
    LittleHelper timer = new LittleHelper();
    private long last = System.currentTimeMillis();

    public class LittleHelper extends Thread{
        @Override
        public void run() {
            while(! this.isInterrupted()){
                synchronized (this){
                    try {
                        ...
                        Log.d("timer", "timer wait terminated");
...
//        view.setText(b);
        ...
        pubnub.publish(channel, b, callback);
    }
}
